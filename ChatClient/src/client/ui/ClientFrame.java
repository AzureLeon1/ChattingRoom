...
import client.backstage.Manager;
import client.util.ManageClientPersonCollection;
import client.util.Tools;
...
public class ClientFrame extends JFrame implements WindowListener{
	...
	private Manager cm;	//后台处理对象
	private JFileChooser jfc;	//文件选择器
	private String Sender;
	private String Getter;
	private JFrame jf;
	public ClientFrame(final String Sender,final String Getter,final Manager cm){
		...
		jb1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				mess.setMessageType(MessageCode.Common_Message_ToPerson);
		...
		jb2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				ChatMessage mess = new ChatMessage();
				mess.setMessageType(MessageCode.Send_FileToPerson);
				mess.setSender(Sender);
				mess.setGetter(Getter);
				...
				if( jfc.getSelectedFile().toPath().toString()!=null){
					...
					m.setMessageType(MessageCode.Common_Message_ToPerson);
					m.setSender(Sender);
					m.setGetter(Getter);
	 ...
	 * @param mess
	 */
	public static void ShowMessage(ChatMessage mess){
