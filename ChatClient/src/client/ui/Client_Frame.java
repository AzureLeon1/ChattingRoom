...
public class Client_Frame extends JFrame {
	...
	public Client_Frame(final String Name,final Manager cm){
		super("欢迎"+Name+"进入聊天室");
		this.Name = Name;
		this.cm = cm;
		this.jf = this;
		...
		jb1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
	             ...
	             mess.setSender(Name);
	             mess.setMessageType(MessageCode.Common_Message_ToAll);
		...
		jb3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				ChatMessage mess = new ChatMessage();
				mess.setMessageType(MessageCode.Send_FileToAll);
				mess.setSender(Name);
				//设置文件名
	 ...
	 * @param mess
	 */
	public void showMessageToAll(ChatMessage mess){
		jta1.append(mess.getSender()+"    "+mess.getTime()+"\r\n"+mess.getContent()+"\r\n");
	}
	
	public void ShowSystemMessage(ChatMessage mess){
