...
import server.backstage.ServerManager;
...
public class ServerFrame extends JFrame{
		...
		jb4.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(i==-1){
					...
					//取出选中的用户，并取出其线程序
					ConnectClient scc = ServerThreadCollection.getServerContinueConnetClient(onLine[i]);
					scc.CloseThread();
				}
    ...
    public static void showMessage(ChatMessage mess){
    	...
    	}else if(mess.getMessageType().equals(MessageCode.CommonMessage)){
